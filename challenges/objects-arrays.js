...
console.log("The Roar of the Tyrannosaurus:", tyrannosaurus.roar());
...
const populationValues = zooAnimals.map(animal => {
  return animal.population
})
const reducer = (accumulator, populationTotal) => accumulator + populationTotal;

populationTotal = populationValues.reduce(reducer);

console.log("Zoo's total animal population across the United States:", populationTotal);
